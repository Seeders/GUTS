class Three_SkeletonUtils {

    getBoneName( bone, options ) {
    ...
    retarget( target, source, options = {} ) {
        ...
        for ( let i = 0; i < bones.length; ++ i ) {
            ...
            bone = bones[ i ];
            name = this.getBoneName( bone, options );
        ...
        if ( options.preserveBonePositions ) {
            ...
            for ( let i = 0; i < bones.length; ++ i ) {
                ...
                bone = bones[ i ];
                name = this.getBoneName( bone, options ) || bone.name;
    ...
    parallelTraverse( a, b, callback ) {
        ...
        while (stack.length > 0) {
            ...
            for (let i = 0; i < a.children.length; i++) {
                stack.push({a: a.children[i], b: b.children[i]});
            }
        }

...
class SkirmishGameSystem extends GUTS.BaseSystem {
    ...
    spawnStartingState() {
        // HeroArena: AutobattlerRoundSystem.onGameStarted() drives leader/hero selection.
    }
    ...
    initializeOnlineMatch() {
        ...
        // HeroArena: hero spawning is driven by AutobattlerRoundSystem after hero selection.
        // AutobattlerRoundSystem.onGameStarted() drives leader/hero selection.

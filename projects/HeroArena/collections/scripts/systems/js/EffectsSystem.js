class EffectsSystem extends GUTS.BaseSystem {
    ...
    updateAllEffects() {
        ...
        for (let i = this.activeEffects.length - 1; i >= 0; i--) {
            ...
            // elapsed < 0: the game clock was reset (resetCurrentTime at battle
            // start) — the effect's startTime is from a previous round and it
            // would otherwise linger for a whole battle. Expire it.

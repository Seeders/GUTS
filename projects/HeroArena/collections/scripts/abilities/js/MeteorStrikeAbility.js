class MeteorStrikeAbility extends GUTS.BaseAbility {
    constructor(game, abilityData = {}) {
        ...
        this.damage       = abilityData.damage       ?? 200;
        this.splashRadius = abilityData.splashRadius ?? 120;
        this.delay        = abilityData.delay        ?? 2.0;
        this.minTargets   = abilityData.minTargets   ?? 0;
        this.meteorHeight = abilityData.meteorHeight ?? 500;
        this.element      = this.enums.element[abilityData.element || 'fire'] ?? this.enums.element.fire;
    }

class RetaliateAbility extends GUTS.BaseAbility {
    ...
    canExecute(casterEntity) {
        ...
        return !(buff && buff.buffType === enums.buffTypes.retaliation);
    }
    ...
    applyBuff(casterEntity) {
        ...
        if (existing && existing.buffType === enums.buffTypes.retaliation) {
    ...
    removeBuff(casterEntity) {
        ...
        const buff = this.game.getComponent(casterEntity, "buff");
        if (buff && buff.buffType === enums.buffTypes.retaliation) {

class BlizzardAbility extends GUTS.BaseAbility {
    constructor(game, abilityData = {}) {
        ...
        this.damage         = abilityData.damage         ?? 25;
        this.blizzardRadius = abilityData.blizzardRadius ?? 120;
        this.duration       = abilityData.duration       ?? 3.0;
        this.tickInterval   = abilityData.tickInterval   ?? 0.3;
        this.shardHeight    = abilityData.shardHeight    ?? 400;

class PolymorphAbility extends GUTS.BaseAbility {
    ...
    execute(casterEntity) {
        ...
        this.logAbilityUsage(casterEntity, "Transforms the target!");
    ...
    applyDebuff(casterEntity, targetId) {
        ...
        this.applyBuff(targetId, {
            buffType: enums.buffTypes.polymorphed,
    ...
    removeDebuff(targetId) {
        const enums = this.game.getEnums();
        if (this.hasBuff(targetId, enums.buffTypes.polymorphed)) {

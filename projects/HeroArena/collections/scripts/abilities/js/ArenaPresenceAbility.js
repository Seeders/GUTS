class ArenaPresenceAbility extends GUTS.BaseAbility {
    ...
    constructor(game, abilityData = {}) {
        ...
        this.intimidationDuration = abilityData.intimidationDuration ?? 15.0;
        this.damageReduction      = abilityData.damageReduction      ?? 0.25;
        this.accuracyReduction    = abilityData.accuracyReduction    ?? 0.2;
        this.fearRadius           = this.range;
        this.element              = abilityData.element || 'psychological';
    }

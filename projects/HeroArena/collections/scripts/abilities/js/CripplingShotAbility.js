class CripplingShotAbility extends GUTS.BaseAbility {
    ...
    execute(casterEntity) {
        ...
        this.logAbilityUsage(casterEntity, "A crippling shot strikes!");
    ...
    applyDebuff(casterEntity, targetId) {
        ...
        this.applyBuff(targetId, {
            buffType: enums.buffTypes.crippled,
    ...
    removeDebuff(targetId) {
        const enums = this.game.getEnums();
        const buff = this.getBuff(targetId, enums.buffTypes.crippled);
        if (!buff) return;
        ...
        this.removeBuff(targetId, enums.buffTypes.crippled);

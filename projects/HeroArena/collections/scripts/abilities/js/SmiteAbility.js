class SmiteAbility extends GUTS.BaseAbility {
    ...
    constructor(game, abilityData = {}) {
        ...
        this.damage              = abilityData.damage              ?? 80;
        this.bonusDamageVsUndead = abilityData.bonusDamageVsUndead ?? 2.0;
        this.pillarDelay         = abilityData.pillarDelay         ?? 0.5;
        this.element             = abilityData.element || 'holy';
    }

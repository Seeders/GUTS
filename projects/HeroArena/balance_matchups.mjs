...
const MATCHUPS = [
    ...
    { name: 'alpha vs giant: ballista+soldiers vs treant', left: ['ballista', 1, '1_sd_soldier', 1], right: ['4_ancientTreant', 1], expect: 'even' },
    ...
    { name: 'anti-air vs air: 2 crossbowmen vs 2 fairy squads (flat bolts)', left: ['2_sd_crossbowman', 2], right: ['fairy', 2], expect: 'left' },

/**
 * ConstructBuildingAction - Performs construction over time
 *
 ...
 */
class ConstructBuildingAction extends GUTS.BaseBehaviorAction {
    ...
    completeConstruction(entityId, buildingId, buildingPlacement, game) {
        if (!buildingPlacement || !buildingPlacement.unitType) {
            console.error('[ConstructBuildingAction] Cannot complete construction - missing placement or unitType');
            return;
        }

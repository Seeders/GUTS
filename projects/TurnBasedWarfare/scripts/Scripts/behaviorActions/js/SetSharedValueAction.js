/**
 * SetSharedValueAction - Utility action
 ...
 */
class SetSharedValueAction extends GUTS.BaseBehaviorAction {
    ...
    execute(entityId, game) {
        ...
        if (!key) {
            console.warn('SetSharedValueAction: key parameter is required');
            return this.failure();
        }

/**
 * SetBuildTargetAction - Gets building info from playerOrder and stores in shared state
 *
 * Reads playerOrder.meta.buildingId and stores:
 * - shared.targetBuilding - Building entity ID
 * - shared.targetPosition - Building position (for MoveToSharedTargetAction)
 * - shared.buildTime - Construction time required
 *
 * Returns SUCCESS if target was set, FAILURE if no valid building
 */
class SetBuildTargetAction extends GUTS.BaseBehaviorAction {

class MultiplayerPlacementSystem extends GUTS.BaseSystem {
    ...
    completeBuildingConstruction(buildingId, buildingPlacement) {
        if (!buildingPlacement || !buildingPlacement.unitType) {
            console.error('[MultiplayerPlacementSystem] Cannot complete construction - missing placement or unitType');
            return;
        }
        ...
        console.log(`[MultiplayerPlacementSystem] Building ${buildingId} (${actualBuildingType.id}) construction complete`);
    }

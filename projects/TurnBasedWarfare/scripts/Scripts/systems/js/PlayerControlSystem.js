...
class PlayerControlSystem extends GUTS.BaseSystem {
    ...
    // ==========================================
    // GAME LOGIC (called by MultiplayerUISystem)
    // ==========================================
    ...
    onUnitSelected(entityId){
        // Game logic only - UI is handled by MultiplayerUISystem
    ...
    onBuildingSelected(entityId) {
        // Called when a building is selected (no action panel for buildings)
        this.stopTargeting();
    }
    showMoveTargets() {
        this.targetingPreview.clear();

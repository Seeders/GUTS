...
if(typeof TerrainDataManager != 'undefined'){
    if (typeof window !== 'undefined') {
        window.TerrainDataManager = TerrainDataManager;
    }

    // Make available as ES module export (new for server)  
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = TerrainDataManager;
    }

    // Make available as ES6 export (also new for server)
    if (typeof exports !== 'undefined') {
        exports.default = TerrainDataManager;
        exports.TerrainDataManager = TerrainDataManager;
    }
}
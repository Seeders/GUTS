class MovementSystem extends GUTS.BaseSystem {
    ...
    update() {
        ...
        const entities = this.game.getEntitiesWith("transform", "velocity", "aiMovement");
    ...
    applyUnitMovementWithSmoothing(entityId, data) {
        ...
        // Play footstep sounds for moving AI units (guards)
        const finalSpeed = Math.sqrt(vel.vx * vel.vx + vel.vz * vel.vz);
        if (finalSpeed > this.MIN_MOVEMENT_THRESHOLD * 2) {

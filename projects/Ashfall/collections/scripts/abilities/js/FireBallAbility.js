class FireBallAbility extends GUTS.BaseAbility {
    ...
    constructor(game, abilityData = {}) {
        ...
        this.damage       = abilityData.damage       ?? 30;
        this.splashRadius = abilityData.splashRadius ?? 80;
        const elName      = abilityData.element || 'fire';
        this.element      = this.enums.element[elName] ?? this.enums.element.fire;

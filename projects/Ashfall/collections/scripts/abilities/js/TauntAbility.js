class TauntAbility extends GUTS.BaseAbility {
    ...
    execute(casterEntity) {
        ...
        this.logAbilityUsage(casterEntity, "Roars a challenge!");
    ...
    applyAoe(casterEntity) {
        ...
        enemies.forEach(eid => {
            ...
            this.game.addComponent(eid, "buff", {
                buffType: enums.buffTypes.taunted,
            ...
            this.game.schedulingSystem.scheduleAction(() => {
                ...
                if (buff && buff.buffType === enums.buffTypes.taunted) {

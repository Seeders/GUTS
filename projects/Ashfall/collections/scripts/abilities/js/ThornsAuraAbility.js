class ThornsAuraAbility extends GUTS.BaseAbility {
    ...
    canExecute(casterEntity) {
        ...
        return !(buff && buff.buffType === enums.buffTypes.thorns_aura);
    }
    ...
    applyBuff(casterEntity) {
        ...
        if (existing && existing.buffType === enums.buffTypes.thorns_aura) {
    ...
    removeBuff(casterEntity) {
        ...
        const buff = this.game.getComponent(casterEntity, "buff");
        if (buff && buff.buffType === enums.buffTypes.thorns_aura) {

class EnchantWeaponAbility extends GUTS.BaseAbility {
    constructor(game, abilityData = {}) {
        ...
        this.elementalDamage = abilityData.elementalDamage ?? 15;
        this.duration        = abilityData.duration        ?? 30.0;
        // availableElements in JSON is an array of names; convert to numeric enum indices
        const names = abilityData.availableElements || ['fire', 'cold', 'lightning'];
        this.availableElements = names.map(n => this.enums.element[n]).filter(v => v != null);
    }

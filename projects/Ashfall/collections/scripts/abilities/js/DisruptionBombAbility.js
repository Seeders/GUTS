class DisruptionBombAbility extends GUTS.BaseAbility {
    constructor(game, abilityData = {}) {
        ...
        this.explosionRadius    = abilityData.explosionRadius    ?? 90;
        this.disruptionDuration = abilityData.disruptionDuration ?? 12.0;
        this.accuracyReduction  = abilityData.accuracyReduction  ?? 0.4;
        this.movementSlowed     = abilityData.movementSlowed     ?? 0.6;
    }

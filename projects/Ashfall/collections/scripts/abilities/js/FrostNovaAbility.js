class FrostNovaAbility extends GUTS.BaseAbility {
    ...
    execute(casterEntity) {
        ...
        this.logAbilityUsage(casterEntity, "Frost erupts outward!");
    ...
    applyAoe(casterEntity) {
        ...
        enemies.forEach(eid => {
            ...
            this.game.addComponent(eid, "buff", {
                buffType: enums.buffTypes.frozen,
            ...
            this.game.schedulingSystem.scheduleAction(() => {
                ...
                if (buff && buff.buffType === enums.buffTypes.frozen) {
